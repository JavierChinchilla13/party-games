        ...
        <AnimatePresence mode="popLayout">
          {players.map((name, index) => (
            <motion.div
              ...
              layout
              className="group flex items-center gap-4 p-3 glass border border-white/10 rounded-2xl focus-within:border-primary/50 transition-all"
            >
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-white/10 to-white/5 flex items-center justify-center text-white/50 group-focus-within:text-primary transition-colors">
